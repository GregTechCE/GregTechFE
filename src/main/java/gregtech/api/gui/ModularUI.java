...
public final class ModularUI implements SizeProvider {
     ...
     */
    public final UIHolder holder;
    public final PlayerEntity entityPlayer;

    public ModularUI(ImmutableBiMap<Integer, Widget> guiWidgets, ImmutableList<Runnable> openListeners, ImmutableList<Runnable> closeListeners, TextureArea backgroundPath, int width, int height, UIHolder holder, PlayerEntity entityPlayer) {
    ...
    public static class Builder {
        ...
        public Builder slot(FixedItemInv itemHandler, int slotIndex, int x, int y, TextureArea... overlays) {
        ...
        public ModularUI build(UIHolder holder, PlayerEntity player) {
