...
public class VerticalTabListRenderer extends TabListRenderer {
    ...
    @Override
    public void renderTabs(MatrixStack matrices, Position offset, List<ITabInfo> tabInfos, int guiWidth, int guiHeight, int selectedTabIndex) {
        ...
        for (int tabIndex = 0; tabIndex < tabInfos.size(); tabIndex++) {
            ...
            tabInfos.get(tabIndex).renderTab(matrices, tabTexture, offset.x + tabXPosition, offset.y + finalPosY, TAB_HEIGHT, TAB_WIDTH, isTabSelected);
    ...
    private static final class LeftTextures {
        ...
        private static final TextureArea startTabInactiveTexture = TABS_LEFT_TEXTURE.getSubArea(0.0f, 0.0f, 0.5f, 1.0f / 3.0f);
        private static final TextureArea startTabActiveTexture = TABS_LEFT_TEXTURE.getSubArea(0.5f, 0.0f, 0.5f, 1.0f / 3.0f);

        private static final TextureArea middleTabInactiveTexture = TABS_LEFT_TEXTURE.getSubArea(0.0f, 1.0f / 3.0f, 0.5f, 1.0f / 3.0f);
        private static final TextureArea middleTabActiveTexture = TABS_LEFT_TEXTURE.getSubArea(0.5f, 1.0f / 3.0f, 0.5f, 1.0f / 3.0f);

        private static final TextureArea endTabInactiveTexture = TABS_LEFT_TEXTURE.getSubArea(0.0f, 2.0f / 3.0f, 0.5f, 1.0f / 3.0f);
        private static final TextureArea endTabActiveTexture = TABS_LEFT_TEXTURE.getSubArea(0.5f, 2.0f / 3.0f, 0.5f, 1.0f / 3.0f);
    ...
    private static final class RightTextures {
        ...
        private static final TextureArea startTabInactiveTexture = TABS_RIGHT_TEXTURE.getSubArea(0.5f, 0.0f, 0.5f, 1.0f / 3.0f);
        private static final TextureArea startTabActiveTexture = TABS_RIGHT_TEXTURE.getSubArea(0.0f, 0.0f, 0.5f, 1.0f / 3.0f);

        private static final TextureArea middleTabInactiveTexture = TABS_RIGHT_TEXTURE.getSubArea(0.5f, 1.0f / 3.0f, 0.5f, 1.0f / 3.0f);
        private static final TextureArea middleTabActiveTexture = TABS_RIGHT_TEXTURE.getSubArea(0.0f, 1.0f / 3.0f, 0.5f, 1.0f / 3.0f);

        private static final TextureArea endTabInactiveTexture = TABS_RIGHT_TEXTURE.getSubArea(0.5f, 2.0f / 3.0f, 0.5f, 1.0f / 3.0f);
        private static final TextureArea endTabActiveTexture = TABS_RIGHT_TEXTURE.getSubArea(0.0f, 2.0f / 3.0f, 0.5f, 1.0f / 3.0f);
