...
public class Element {
    ...
    public static class Builder{
        ...
        public Builder(String name, String chemicalFormula) {
            this.name = name;
            this.chemicalFormula = chemicalFormula;
        }

        public Element.Builder isotope(){
            this.isIsotope = true;
        ...
        public Element build(){
            ...
            element.isIsotope = this.isIsotope;
            element.chemicalProperty = new ChemicalProperty.Builder().isElement(chemicalFormula).build();
