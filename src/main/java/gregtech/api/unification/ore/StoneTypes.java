...
public class StoneTypes {
    ...
    public static StoneType GRANITE = new StoneType(1, "granite", new ResourceLocation("blocks/stone_granite"), SoundType.STONE, MaterialForm.ore, Materials.Granite, "pickaxe", 0,
    ...
    public static StoneType DIORITE = new StoneType(2, "diorite", new ResourceLocation("blocks/stone_diorite"), SoundType.STONE, MaterialForm.ore, Materials.Diorite, "pickaxe", 0,
    ...
    public static StoneType ANDESITE = new StoneType(3, "andesite", new ResourceLocation("blocks/stone_andesite"), SoundType.STONE, MaterialForm.ore, Materials.Andesite, "pickaxe", 0,
    ...
    public static StoneType RED_SANDSTONE = new StoneType(9, "red_sandstone", new ResourceLocation("blocks/red_sandstone_normal"), new ResourceLocation("blocks/red_sandstone_top"), SoundType.STONE, MaterialForm.oreSand, Materials.SiliconDioxide, "pickaxe", 0,
    ...
    public static StoneType BLACK_GRANITE = new StoneType(10, "black_granite", new ResourceLocation(GTValues.MODID, "blocks/stones/granite/granite_black_stone"), SoundType.STONE, MaterialForm.oreBlackgranite, Materials.GraniteBlack, "pickaxe", 0,
    ...
    public static StoneType RED_GRANITE = new StoneType(11, "red_granite", new ResourceLocation(GTValues.MODID, "blocks/stones/granite/granite_red_stone"), SoundType.STONE, MaterialForm.oreRedgranite, Materials.GraniteRed, "pickaxe", 0,
    ...
    public static StoneType MARBLE = new StoneType(12, "marble", new ResourceLocation(GTValues.MODID, "blocks/stones/marble/marble_stone"), SoundType.STONE, MaterialForm.oreMarble, Materials.Marble, "pickaxe", 0,
    ...
    public static StoneType BASALT = new StoneType(13, "basalt", new ResourceLocation(GTValues.MODID, "blocks/stones/basalt/basalt_stone"), SoundType.STONE, MaterialForm.oreBasalt, Materials.Basalt, "pickaxe", 0,
